...
#### to do - set to more reasonable values to run multiple times...but need a computer that is not low on juice
...
# setup NMS code here in R, using my general path from MATLAB
